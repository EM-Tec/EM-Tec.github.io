...
<!--more-->
![首頁::round](https://EM-Tec.github.io/images/frog_check_in-home.png)
...
## 功能
### 新增學生
![新增學生::round](https://EM-Tec.github.io/images/frog_check_in-add.png)
輸入名稱並按新增即可。<br />
...
### 點名
![點名畫面::round](https://EM-Tec.github.io/images/frog_check_in-check.png)
網站會從表單取得學生名單並顯示。只需要點擊名稱即可完成報到。<br />
![報到成功會提示你還剩下幾堂課::round](https://EM-Tec.github.io/images/frog_check_in-checked.png)
{{% notice notice "提醒" %}}
...
### 查詢記錄
![查詢毛宥恩的報到紀錄::round](https://EM-Tec.github.io/images/frog_check_in-search.png)
